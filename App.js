...
<Text style = {styles.love}> Lovelyn Magsino </Text>
<Text style = {styles.course}>  Information Technology 3</Text>
    ...
    <View style = {styles}>
      ...
      <View style={styles.row}>
        <Text style={styles.elec3}>ELEC 3</Text>
      ...
      <View style={styles.row}>
        <Text style ={styles.elec3}>IT 311</Text>
        <View style={styles.firstsub}>
        ...
        <View style={styles.row}>
          <Text style={styles.elec3}>IT 312</Text>
          <View style={styles.firstsub}>
      ...
      <View style={styles.row}>
        <Text style={styles.elec3}>IT 313</Text>
          <View style={styles.firstsub}>
